...
class AlterStatusFacade {
    constructor(requestService, scheduleService) {
        this.requestService = requestService ? requestService : new RequestService();
        this.scheduleService = scheduleService ? scheduleService : new ScheduleService();
        this.db = DB;
    }
